...
$sqlKill = "SELECT 
		...
		$result = $db->query($sqlKill);
		 ...
		 echo "
		 <tr class='row'><td width='35'><a href='hero.php?hero=$list[topHero]' title='$list[topHeroName]'>
		 <img style='vertical-align: middle;' width='32' height='32' src='img/heroes/$himg.gif' border=0/></a></td>
		 <td width='32' align='left'>(<a href='game.php?gameid=$list[topGame]'>$list[topValue]</a>) </td>

...
**********************************************/
   ...
   $stepKills = "SELECT original as topHero, description as topHeroName, kills as topValue, b.name as topUser, a.gameid as topGame
		...
		{echo "<tr class='row'><td align='left' width='180'><a href='hero.php?hero=$list[topHero]' title='$list[topHeroName]'>
		 <img alt='' style='vertical-align: middle;' width='32' height='32' src='img/heroes/$himg.gif' border=0/></a>
		 (<a href='game.php?gameid=$list[topGame]'>$list[topValue]</a>) 
		 
		 <a href='user.php?u=$list[topUser]' title='$list[topUser]'>$list[topUser]</a>
		 </td></tr>
		 ";} else {echo "<tr class='row'><td width='180'></td></tr>";}
		 }
   ...
   {	
	 ...
	 <td valign='top'>
		...
		if ($list["topValue"]>0)
		{echo "<tr class='row'><td align='left' width='180'>($list[topValue]) 
		 <a href='user.php?u=$list[topUser]' title='$list[topUser]'>$list[topUser]</a>
		 </td></tr>";} else {echo "<tr class='row'><td width='180'></td></tr>";}
		 }

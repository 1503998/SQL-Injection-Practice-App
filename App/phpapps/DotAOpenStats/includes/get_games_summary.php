<?PHP
  ...
  ?><div align='center'><table class='tableA'><tr>
	 ...
	 <td width='90px'><? echo $_sentWon." (".$_sentPerc;?>%)</td>
	 ...
	 <td width='90px'><? echo $_scourWon." (".$_scourPerc;?>%)</td>
	 ...
	 <td width='120px'><? echo $_draw." (".$_drawPerc;?>%)</th>
	 <td></td>
	 <td></td>
	 <td></td>
	 <td></td>
     ...
     <th width='33%' class='padLeft'><? echo $lang["total_games"]." ".$numrows;?></th>

...
COLLATE latin1_swedish_ci
	...
	while ($list = $db->fetch_array($result,'assoc')) {
		...
		echo "<tr class='row'>
		<td width='40'><a href='hero.php?hero=$hid'><img width='32' height='32' alt='' src='./img/heroes/$hid.gif' border=0 /></a></div></td>
		<td width='150'><a href='hero.php?hero=$hid'>$hero</a></td>
		<td width='50'><div align='center'>$totgames</div></td>

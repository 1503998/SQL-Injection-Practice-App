...
**********************************************/
  ...
  $pageTitle = "$realname";
   ...
   echo str_replace($tags, $data, file_get_contents("./style/$default_style/user_row.html"));
		...
		<table class="tableA">
		   <tr>
		      <th class="padLeft"><img style="vertical-align: middle;" alt="" width="16" height="16" src="./img/achievements/play.gif"> <a href="#info" name="info" class="poplink" onclick="showhide('div1');return false;" id="link">Show <?=$realname?> Achievements</a></th>
		   </tr>
		</table>
		</div>
		...
		<table class='tableA'>
		  ...
		  <tr class='row'>
		    <td  width='180'  class='padLeft'><div align='left'><a href='game.php?gameid=<?=$fastGameWonID?>'><?=$fastGameWonName?></a></div></td>
		    <td width='120'><div align='left'><?=$fastGameWonTime?></div></td>
		    <td width='56'><div align='center'><?=$fastGameWonKills?></div></td>
		    <td width='56'><div align='center'><?=$fastGameWonDeaths?></div></td>
		    <td width='56'><div align='center'><?=$fastGameWonAssists?></div></td>
		    <td width='56'><div align='center'><?=$fastGameWonCreeps?></div></td>
		    <td width='56'><div align='center'><?=$fastGameWonDenies?></div></td>
		    <td width='56'><div align='center'><?=$fastGameWonNeutrals?></div></td>
		    <td></td>
		  </tr>
		  <tr>
		    <th class='padLeft' width='180'><b><?=$lang["longest_game"]?></b></th>
		    <th><div align='left'><b><?=$lang["duration"]?>:</b></div></th>
		    <th><div align='center'><b><?=$lang["kills"]?></b></div></th>
		    <th><div align='center'><b><?=$lang["deaths"]?></b></div></th>
		    <th><div align='center'><b><?=$lang["assists"]?></b></div></th>
		    <th><div align='center'><b><?=$lang["creeps"]?></b></div></th>
		  ...
		  <tr class='row'>
		    <td width='180' class='padLeft' width='180'><div align='left'><a href='game.php?gameid=<?=$longestGameWonID?>'><?=$longestGameWonName?></a></div></td>
		    <td width='120'><div align='left'><?=$longestGameWonTime?></div></td>
		    <td width='56'><div align='center'><?=$longestGameWonKills?></div></td>
		    <td width='56'><div align='center'><?=$longestGameWonDeaths?></div></td>
		    <td width='56'><div align='center'><?=$longestGameWonAssists?></div></td>
		    <td width='56'><div align='center'><?=$longestGameWonCreeps?></div></td>
		    <td width='56'><div align='center'><?=$longestGameWonDenies?></div></td>
		    <td width='56'><div align='center'><?=$longestGameWonNeutrals?></div></td>
		    <td></td>
		  </tr>
		  </table>
		  </div>
  ...
  $sortdb = 'DESC';
    ...
    $result = $db->query($sql);
	 ...
	 <table class='tableA'>
	 <tr>
	   <th style='padding-left:12px;width:200px;'><div align='left'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=game&sort=<?=$sort?>'><?=$lang["game_name"]?></a></div></th>
       <th><div align='center'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=type&sort=<?=$sort?>'><?=$lang["type"]?></a></div></th>
	   <th><div align='center'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=date&sort=<?=$sort?>'><?=$lang["date"]?></a></div></div></th>
       <th><div align='left'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=hero&sort=<?=$sort?>'><?=$lang["hero_played"]?></a></div></th>
	   <th><div align='center'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=kills&sort=<?=$sort?>'><?=$lang["kills"]?></a></div></div></th>
	   <th><div align='center'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=deaths&sort=<?=$sort?>'><?=$lang["deaths"]?></a></div></th>
	   <th><div align='center'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=assists&sort=<?=$sort?>'><?=$lang["assists"]?></a></div></th>
	   <th><div align='center'><a href='<?=$_SERVER['PHP_SELF']?>?u=<?=$username?>&order=ratio&sort=<?=$sort?>'><?=$lang["kd"]?></a></div></th>
	...
	$hero_img = "<a href='hero.php?hero=$hid'><img border=0 alt='' title='$hero' width='28' style='vertical-align: middle;' src='./img/heroes/$hid.gif'/></a>"; 
	?>
	<tr class='row'>
	  <td width="200" class="padLeft"><div align='left'><a href='game.php?gameid=<?=$gameid?>'><?=$gamename?></a></div></td>
	  <td width="30"><?=$type?></td>
  ...
  //Cache this page
  if ($cachePages == '1' AND $cacheAllUsers == 1)

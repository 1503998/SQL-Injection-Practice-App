          ...
          <table>
            ...
            <tr>
              ...
              <td><?php if ($global_google_test) { ?>
                <input type="radio" name="global_google_test" value="1" checked>
                <?php echo $text_yes; ?>
                <input type="radio" name="global_google_test" value="0">
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="global_google_test" value="1">
                <?php echo $text_yes; ?>
                <input type="radio" name="global_google_test" value="0" checked>
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              ...
              <td>
                  ...
                  <input type="radio" name="global_google_currency" value="<?php echo $currency['value']; ?>" checked>
                  <?php echo $currency['text']; ?><br />
                  <?php } else { ?>
                  <input type="radio" name="global_google_currency" value="<?php echo $currency['value']; ?>">
                  <?php echo $currency['text']; ?><br />
                  <?php } ?>
                  <?php } ?>
              </td>

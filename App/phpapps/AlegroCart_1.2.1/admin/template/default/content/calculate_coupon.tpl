        ...
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="global_coupon_status">
                  <?php if ($global_coupon_status) { ?>
            ...
            <tr>
              ...
              <td><input type="text" name="global_coupon_sort_order" value="<?php echo $global_coupon_sort_order; ?>" size="1"></td>
            </tr>
          </table>
        </div>
      </div>

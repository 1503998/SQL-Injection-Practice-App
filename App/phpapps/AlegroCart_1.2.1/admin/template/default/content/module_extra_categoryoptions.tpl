        ...
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="catalog_category_options_status">
                  <?php if ($catalog_category_options_status) { ?>
			...
			<tr>
			  ...
			  <td><select name="catalog_category_columns">
			    <?php foreach($columns as $column){?>
				  <?php if($column == $catalog_category_columns) {?>
			...
			<tr>
              ...
              <td><select name="catalog_category_display_lock">
                  <?php if ($catalog_category_display_lock) { ?>
                  <option value="1" selected><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>

        ...
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="global_subtotal_status">
                  <?php if ($global_subtotal_status) { ?>
            ...
            <tr>
              ...
              <td><input type="text" name="global_subtotal_sort_order" value="<?php echo $global_subtotal_sort_order; ?>" size="1"></td>
            </tr>
          </table>
        </div>
      </div>

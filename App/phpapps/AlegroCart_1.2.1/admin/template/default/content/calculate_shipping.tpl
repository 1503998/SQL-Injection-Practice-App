        ...
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="global_shipping_status">
                  <?php if ($global_shipping_status) { ?>
            ...
            <tr>
              ...
              <td><input type="text" name="global_shipping_sort_order" value="<?php echo $global_shipping_sort_order; ?>" size="1"></td>
            </tr>
          </table>
        </div>
      </div>

<?php
	...
	**************************************************/
	...
	function avatar_url($file_url) {
    	...
    	$sql = "UPDATE ". $_G['mysql_prefix'] ."users SET image_type='image/jpeg', avatar='".$imgData."', 
    		image_name='".$file_url."'
	...
	function avatar_upload(){
    	...
    	if(is_uploaded_file($_FILES['userfile']['tmp_name'])) {
        	...
        	if($_FILES['userfile']['size'] < $maxsize){
        		...
        		$sql = "UPDATE ". $_G['mysql_prefix'] ."users SET image_type='".$size['mime']."', avatar='".$imgData."', image_name='".$_FILES['userfile']['name']."' WHERE login='".$_SESSION['username']."'";

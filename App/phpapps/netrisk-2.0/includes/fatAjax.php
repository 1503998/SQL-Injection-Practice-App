...
function filter_smilies(s) {
	for (var i = 0; i < smilies.length; i++) {
		...
		var replace = '<img src="images/smilies/' + smilies[i][1] + '" class="wp-smiley" alt="' + smilies[i][0].replace(/\\/g, '') + '" />';
...
var GetChaturl = "<?php echo dirname($_SERVER['PHP_SELF']); ?>/chat.php?jalGetChat=yes";
var SendChaturl = "<?php echo dirname($_SERVER['PHP_SELF']); ?>/chat.php?jalSendChat=yes";
var httpReceiveChat;
var httpSendChat;

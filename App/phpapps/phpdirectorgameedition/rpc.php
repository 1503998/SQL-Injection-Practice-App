...
$newtotals = mysql_query("SELECT total_votes, total_value, used_ips FROM $rating_dbname.$rating_tableName WHERE $rating_tableID='$id_sent' ")or die(" Error: ".mysql_error());

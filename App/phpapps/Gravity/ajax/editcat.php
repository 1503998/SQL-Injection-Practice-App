...
if($_SESSION['perm'] == '1')
{
    ...
    mysql_query("UPDATE " . $prefix . "categories SET catname = '{$_POST['name']}' WHERE cat_id = '{$_POST['cat_id']}'") OR DIE("Gravity Board X was unable to save changes to the database: " . mysql_error());

...
if($_SESSION['perm'] == '1')
{
    ...
    mysql_query("DELETE FROM " . $prefix . "boards WHERE board_id = '{$_POST['board_id']}'") OR DIE("Gravity Board X was unable to save changes to the database: " . mysql_error());
    mysql_query("DELETE FROM " . $prefix . "posts WHERE board_id = '{$_POST['board_id']}'") OR DIE("Gravity Board X was unable to save changes to the database: " . mysql_error());

    echo '<span class="errortext">Board deleted successfully!</span>';

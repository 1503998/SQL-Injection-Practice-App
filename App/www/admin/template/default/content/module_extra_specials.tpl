        ...
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="catalog_specials_status">
                  <?php if ($catalog_specials_status) { ?>
            ...
            <tr>
              ...
              <td><input type="text" name="catalog_specials_limit" value="<?php echo $catalog_specials_limit; ?>" size="1" /></td>
            </tr>
			<tr>
			  <td><?php echo $entry_height; ?></td>
			  <td><input type="text" name="catalog_specials_image_height" value="<?php echo $catalog_specials_image_height; ?>" size="3"></td>
			</tr>
			<tr>
			  <td><?php echo $entry_width; ?></td>
			  <td><input type="text" name="catalog_specials_image_width" value="<?php echo $catalog_specials_image_width; ?>" size="3"></td>
			</tr>
            <tr>
              <td><?php echo $entry_addtocart; ?></td>
              <td><select name="catalog_specials_addtocart">
                  <?php if ($catalog_specials_addtocart) { ?>
                  <option value="1" selected><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>

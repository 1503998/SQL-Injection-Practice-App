        ...
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="catalog_latest_status">
                  <?php if ($catalog_latest_status) { ?>
            ...
            <tr>
              ...
              <td><input type="text" name="catalog_latest_limit" value="<?php echo $catalog_latest_limit; ?>" size="1" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_columns; ?></td>
              <td><input type="text" name="catalog_latest_columns" value="<?php echo $catalog_latest_columns; ?>" size="1" /></td>
            </tr>			
            <tr>
              <td><?php echo $entry_total; ?></td>
              <td><input type="text" name="catalog_latest_total" value="<?php echo $catalog_latest_total; ?>" size="3"></td>
            </tr>			
			<tr>
			  <td><?php echo $entry_height; ?></td>
			  <td><input type="text" name="catalog_latest_image_height" value="<?php echo $catalog_latest_image_height; ?>" size="3"></td>
			</tr>
			<tr>
			  <td><?php echo $entry_width; ?></td>
			  <td><input type="text" name="catalog_latest_image_width" value="<?php echo $catalog_latest_image_width; ?>" size="3"></td>
			</tr>
            <tr>
              <td><?php echo $entry_addtocart; ?></td>
              <td><select name="catalog_latest_addtocart">
                  <?php if ($catalog_latest_addtocart) { ?>
                  <option value="1" selected><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>

...
<?php include("post/editor.php"); ?>
  ...
  <p align="center"><input type="hidden" name="formsent"><input type="hidden" name="board_id" value="<?php echo $_GET['board_id']; ?>"><input class=button type="submit" name="submit" value="Post">
  <input class=button type="reset" value="Clear Form" name="cf"></p>
</form></td>
  </tr>
...
<?php
        ...
        {
            echo '<tr><td align="center" class="header" height="18"><font class="headerfont">Original Message</font></td></tr>';
            echo '<tr><td>';

<?php
   ...
   **********************************************/
   ...
   ?><tr>
         <td valign='top' class='padLeft' width='52' align='left'><a href='item.php?item=<?=$itemID?>'><img border=0 width='48' height='48' src='./img/items/<?=$icon?>'></a></td>
         <td class='padLeft' align='left'><a onClick='showhide("<?=$itemID?>");' href='javascript:;'><?=$itemName?></a><div style='display:none;' id = '<?=$itemID?>'><?=$itemSummary?><br><a href='item.php?item=<?=$itemID?>'><?=$lang["more_info"]?></a><br><br></div>
        </td>
   </tr><?php
   }
  ?>

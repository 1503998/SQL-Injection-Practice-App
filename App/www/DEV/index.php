<?PHP
	...
	define("MAX_SIZE", 20); //20 KB max upload
...
<?
   ...
   ?><div align="center">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	 ...
	 //CHECK ADMINISTRATORS
      ...
      $_SESSION["logged"] = 1;
         ...
         curl_exec ($ch);
         curl_close ($ch);
		 } else {echo "<br /><span>Auto-check version failed. Curl is NOT installed. Please check your PHP configuration.</span>";}
	 	 }
		 else
		    {
	...
	<p style='margin-right:12px;' class='alignright'>DotA OpenStats ".VERSION."</p></div><hr>";
	...
	if (isset($_GET['tools'])   AND $_SESSION["user_level"] <=1) {$back_up = "<b>Tools</b>";}
	...
	echo "<div align='center'><table style='margin:4px;'><tr><td align='left'>
	<a class='menuButtons' href='index.php'>$dashboard</a>";
	
	if ($_SESSION["user_level"] <=2)
	{echo "<a class='menuButtons' href='index.php?bans'>$manage_bans</a>";}
	
	if ($_SESSION["user_level"] <=1)
	{echo "<a class='menuButtons' href='index.php?heroes'>$edit_h</a>";}
	
	if ($_SESSION["user_level"] <=1)
	{echo "<a class='menuButtons' href='index.php?items'>$edit_i</a>";}
	
	if ($_SESSION["user_level"] <=1)
	{echo "<a class='menuButtons' href='index.php?games&check'>$gameid_check</a>";}
	
	if ($_SESSION["user_level"] <=3)
	{echo "<a class='menuButtons' href='index.php?addnews'>$add_news</a>";}
		
	if ($_SESSION["user_level"] <=1)
	{echo "<a class='menuButtons' href='index.php?admins'>$_admins</a>";}
	
	if ($_SESSION["user_level"] <=1)
	{echo "<a class='menuButtons' href='index.php?conf'>$os_configuration</a>";}
	
	if ($_SESSION["user_level"] <=1)
	{echo "<a class='menuButtons' href='index.php?tools'>$back_up</a>";}
	
	if ($_SESSION["user_level"] <=3)
	{echo "<a class='menuButtons' href='../index.php'>(Go to DotA OS)</a>";}
	
		
	$sel1 = ""; $sel2 = ""; $sel3 = "";
	
	if ($admin_style == "style3.css") {$sel3 = "selected";}
	...
	while (false !== ($file = readdir($handle))) 
	{
	       ...
	       if (strstr($file,".css")==true and $file!="editor.css")
        {       
        $style = str_replace(".php","",$file);		
        if (trim($admin_style) == trim($file)) {$selected="selected";}
        $chooses.='<option  '.$selected.' value="index.php?style=' . $style . '">' . str_replace(".css","",$style) . '</option>';
		}
    }}
	
	?></td>
	<td width='160'>Admin style: <select onchange='location = this.options[this.selectedIndex].value;' name='admin_style'>
	<?=$chooses?>
	</select>
	</td>
	</tr></table></table></div>
	...
	{admin_write_value_of('$admin_style', "$admin_style", $_GET["style"]);}
   ...
   ?><div align='center'><table class='tableA'><tr>
              ...
              <img alt='' style='vertical-align: middle;' width='22' height='22' 
	 ...
	 while ($row = $db->fetch_array($result,'assoc'))
		...
		$heroimg = "<a title='View $description' href='../hero.php?hero=$hid'><img alt='' width='48' height='48' src='../img/heroes/$hid.gif' border=0 /></a><br/><br/>";
		...
		<tr class='row'>
			...
			<td width='140' valign='top'><div align='center'><a title='Edit <?=$description?>' href='index.php?heroes&edit=<?=$hid?>'><b><?=$description?></b></a><br/>
			 <?=$heroimg?></div></td>
			<td width='380'><?=$summ?><br/><br/></td>
			<td width='140' valign='top'><?=$stats?></td>
			<td valign='top'><?=$skills?></td>
		    <td valign='top'>
			<div align='center'><a title='Edit: <?=$description?>' href='index.php?heroes&edit=<?=$hid?>'><b>Edit</b></a></div></td>
		 </tr>
			 <?php
			 } 
			 ?>
...
function confirmDelete(delUrl) {
  if (confirm('Are you sure you want to delete this Hero <?=$description?> (<?=$hid?>) ?')) {
	...
	<tr><td></td><td>
		...
		<div align="center">
		<table style="width:70%"><tr><th><div align="center">Preview</div></th></tr>
		<tr><td style="padding:12px;">
		<img alt="" style="vertical-align:middle" src="../img/heroes/<?=$hid?>.gif" /> <strong><?=$description?></strong><br />
		<?=$summ?><br/><br/>
		<?=$stats?><br/><br/>
		<?=$skills?>
		</td></tr>
...
//////////////////////////////////////////////////////////////
	...
	?><div align='center'><table style='width:98%'><tr><td align='left'>
	<a href='index.php?addban'><b><img alt='' style='vertical-align: middle;' width='22' height='22' src='../img/items/BTNCritterChicken.gif' border=0/> Add ban </a> </td>
	
	 <td  align='right'><a href='index.php?remove_dupbans'><b><img alt='' style='vertical-align: middle;' width='20' height='20' src='../img/items/BTNCancel.gif' border=0 /> Remove duplicate bans </a></td>
	 </tr></table></div>
	...
	?><tr class='row'>
	<td width='48'><input type='checkbox' name='checkbox[]' value='<?=$row["id"]?>'><?=$row["id"]?></td>
	<td width='130' style='padding-left:2px'><b><a href='../user.php?u=<?=$name?>'><?=$row["name"]?></a></b></td>
	<td width='160'><?=$row["gamename"]?></td>
	<td width='64'><a title='Delete ban: <?=$row["name"]?>' href='index.php?bans&delete=<?=$row["id"]?>'>Delete</a></td>
	<td width='90'><?=$ip?></td>
	<td width='150'><div align='center'><?=$date?></div></td>

	<td width='90'><a href='../user.php?u=<?=$bannedby?>'><?=$row["admin"]?></a></td>
	<td width='220'><?=$row["reason"]?></td>
	</tr><?
	}
	?></table>
  ...
  if ($banrecords>=1)
  {
	...
	<td>$date</td>
	<td>$row[gamename]</td>
	<td width='250' title='$row[reason]'>$reason</td>
	<td>$row[admin]</td>
	</tr>";
	  }
  }
  ...
  echo "</table></div>$res<br/><br/><a href='index.php?bans'>Back to previous page</a><br><br>";
	...
	<tr>
	<td align="right" width="96" style="padding-right:4px;">Name*</td><td><input size="40" maxlength="40" value="" name="banname"></td></tr>
	
	<tr>
	<td align="right" width="96" style="padding-right:4px;">Game name</td><td><input size="40" maxlength="150" value="" name="bangame"></td></tr>
	
	<tr>
	<td align="right" width="96" style="padding-right:4px;">Server</td><td><input size="20" maxlength="60" value="" name="banserver">

</td></tr>
	
	<tr>
	<td align="right" width="96" style="padding-right:4px;">Banned by</td><td><input size="40" maxlength="40" value="" name="banby"></td></tr>
	
	<tr>
	<td align="right" width="96" style="padding-right:4px;">Reason</td><td><input size="40" maxlength="150" value="" name="banreason"></td></tr>
	
	<td></td>
	<td>
	<input type="submit" name="Submit" class="inputButton" value="Add ban" />
	<input type="button" onclick="location='index.php?bans'" name="Submit" class="inputButton" value="Cancel" /></td>
	</tr></table>
    </div></form>
	<br/><br/>
	<?php
	...
	<table style="width:70%"><tr>
	<td align="center" width="96">HeroID</td><td><input size="6" maxlength="6" value="" name="heroid"> Add image <input type="file" name="image">  (max 20KB, .gif only)</td></tr>
	
	<tr>
	<td align="center" width="96">Original</td><td><input size="6" maxlength="6" value="" name="orig"></td></tr>
	
	<tr>
	<td align="center" width="96">Description</td><td><input size="60" maxlength="60" value="" name="desc"> (Hero name) </td></tr>
	
	<tr>
	<td align="center" valign="top" width="96">Summary</td><td><textarea style="width:600px;height:200px" name="summ"></textarea><br/><br/></td></tr>
	
	<tr>
	<td align="center" valign="top" width="96">Stats</td><td><textarea style="width:600px;height:90px" name="stats"></textarea></td></tr>
	
	<tr>
	<td align="center" valign="top" width="96">Skills</td><td><textarea style="width:600px;height:90px" name="skills"></textarea></td></tr>
	
	<tr><td></td>
	    <td>
		<input type="submit" name="Submit" class="inputButton" value="Add hero" />
		<input onclick="location='index.php?heroes'" type="button" name="Submit" class="inputButton" value="Cancel" />
		</td>
			</tr></table>
        </div></form><br/><br/><?php
   ...
   $rowsperpage = 50;
	...
	?><div align='center'><table class='tableA'><tr>
	 ...
	 while ($row = $db->fetch_array($result,'assoc'))
		...
		$itemimg = "<a href='index.php?items&edit=$itemid'><img alt='' width='32' height='32' src='../img/items/$icon' border=0 /></a><br/>";
			 
			 
			  echo "<tr class='row'>
			 <td width='32' valign='top'><div align='center'>$itemid</div></td>
			 <td width='48'><div align='center'>$itemimg</div></td>
			 
			 <td width='150' valign='top'>
			 <div align='center'><a href='index.php?items&edit=$itemid'>$name</a></div></td>
			 
			 <td width='140' valign='top'><div align='center'>$shortname</div><br/></td>
			 <td width='200' valign='top'><div align='center'><b>$description</b></div></td>

			 <td width='48' valign='top'><div align='center'><a title='Edit: $description' href='index.php?items&edit=$itemid'><b>Edit</b></a></div></td>
			 </tr>";
	...
	{$dis_image = '<img alt="" width="64" height="64" style="vertical-align: middle;" src="../img/items/'.$icon2.'" />';  
	$small_image = '<img alt="" width="26" height="26" style="vertical-align: middle;" src="../img/items/'.$icon.'" />';}
...
function confirmDelete(delUrl) {
  if (confirm('Are you sure you want to delete this $shortname ($item) ?')) {
	...
	<tr>
	<td width="96">ItemID</td><td><input size="6" maxlength="6" value="'.$item.'" name="itemid"></td></tr>
	
	<tr>
	<td width="96">Name</td><td><input size="60" maxlength="60" value="'.$name.'" name="name"></td></tr>
	
	<tr>
	<td width="96">Short name</td><td><input size="60" maxlength="60" value="'.$shortname.'" name="short"> </td></tr>
	
	<tr>
	<td width="96">Icon</td><td><input '.$dis.' size="60" maxlength="60" value="'.$icon.'" name="icon">
     '.$small_image.'
	</td></tr>
	
	<tr>
	<td valign="top" width="120">Summary</td><td>
	...
	<tr><td></td><td>
		...
		<input type="button" onclick="location=\'index.php?items\'" class="inputButton" value="Cancel" />
		'.$del_button.'
		</td>
			</tr></table>
        </div></form>
...
function confirmDelete(delUrl) {
  if (confirm('Are you sure you want to delete this news?')) {
	...
	<td valign='top' width='250'><b><a title='Edit news' href='index.php?addnews&edit_news=$row[news_id]'>$title</a></b><br><hr style='width:50%;'>$text<br><br><br></td>
	<td valign='middle' width='80'><div align='center'>$dateis</div></td>
	<td valign='middle' width='80'><div align='center'><a href='index.php?addnews&edit_news=$row[news_id]'>Edit</a>
  ...
  /////////////////////////////////////////////////////////
    ...
    if (isset($_GET['conf']) AND $_SESSION['user_level'] <=1)
	  ...
	  $WarnAndExpireDate = get_value_of('$WarnAndExpireDate');
      $WarnAndExpireDate = trim($WarnAndExpireDate);
		  
		  if ($WarnAndExpireDate == "1") {$warny = "checked";$warnn = "";} else {
          $warny = "";
          $warnn = "checked";}
     ...
     $cacheDir = trim($cacheDir);	
	  ...
	  //SIGNATURE
	  $enableSignatures = get_value_of('$enableSignatures');
      $enableSignatures = trim($enableSignatures); 
      if ($enableSignatures == "1") {$signy = "checked";$signn = "";} else {
          $signy = "";
          $signn = "checked";}	

      $sigMinGames = get_value_of('$sigMinGames');
      $sigMinGames = trim($sigMinGames);

      $sigCacheTime = get_value_of('$sigCacheTime');
      $sigCacheTime = trim($sigCacheTime);
	  
	  $sigImageQuality = get_value_of('$sigImageQuality');
      $sigImageQuality = trim($sigImageQuality);  
	  
	  $enableItemsPage = get_value_of('$enableItemsPage');
      $enableItemsPage = trim($enableItemsPage); 
      if ($enableItemsPage == "1") {$itpy = "checked";$itpn = "";} else {
          $itpy = "";
          $itpn = "checked";}	
	  
	  $enableSafeListPage = get_value_of('$enableSafeListPage');
      $enableSafeListPage = trim($enableSafeListPage); 
      if ($enableSafeListPage == "1") {$sfpy = "checked";$sfpn = "";} else {
          $sfpy = "";
          $sfpn = "checked";}	
		  
	  $sigCountryFlags = get_value_of('$sigCountryFlags');
      $sigCountryFlags = trim($sigCountryFlags); 
      if ($sigCountryFlags == "1") {$cfsy = "checked";$cfsn = "";} else {
          $cfsy = "";
          $cfsn = "checked";}

      $ParsePDHeroes = get_value_of('$ParsePDHeroes');
      $ParsePDHeroes = trim($ParsePDHeroes); 
      if ($ParsePDHeroes == "1") {$pdhy = "checked";$pdhn = "";} else {
          $pdhy = "";
          $pdhn = "checked";}	
	  ...
	  if (file_exists("../includes/ip_files/countries.php") AND function_exists("iptocountry"))
	  {$cfinst = "<span style='color:yellow'>Installed</span>";}
	  else
	  {$cfinst = "<span style='color:red'><b>Not installed</b>.</span> (Please disable this option or install addon).";}
	  
	  if ($_SERVER['REQUEST_METHOD'] != 'POST') {
	  $handle = opendir("../style");
	  echo '<div align="center"> <form method="post" action="">
	  <table style="width:720px;" border=1><tr><th>Configuration</th><th></th></tr>
	  <tr class="row">
	  <td width="160">Default Style</td>
	  <td>
	  <select name="style">';
	   while (false !== ($file = readdir($handle)))
	   {
	   $selected = "";
	   if ($file !="." AND  $file !="index.html" AND $file !=".." AND strstr($file,".png")==false AND strstr($file,".css")==false AND strstr($file,".js")==false AND strstr($file,".")==false AND !strstr($file,".htaccess") )
        {       
		$lang = $lang.$file;
        $style = str_replace(".php","",$file);		
        if (trim($style) == trim($default_style)) {$selected="selected";}
	  ...
	  $handle = opendir("../lang");
	   ...
	   {
	   $selected = "";
	   if ($file !="." AND  $file !="index.html" AND $file !=".." AND strstr($file,".png")==false AND strstr($file,".css")==false AND strstr($file,".js")==false AND !strstr($file,".htaccess"))
        {       
		$lang = $lang.$file;
        $language = str_replace(".php","",$file);		
        if (trim($language) == trim($default_language)) {$selected="selected";}
        echo '<option  '.$selected.' value="' . $language . '">' . $language . '</option>';
		}
	   }
	  
	  echo '</select></td></tr><tr>
	  <td width="200">Head admin</td>
	  <td><input value="'.$head_admin.'" type="text" name="head" maxlength=30 size=30 /></td></tr>
	  
	  <tr  class="row">
	  <td width="200">Bot Name</td>
	  <td><input value="'.$bot_name.'" type="text" name="bot" maxlength=30 size=30 /></td></tr>
	  
	  <tr class="row">
	  <td width="200">Bans per page</td>
	  ...
	  <tr class="row">
	  <td width="200">Games per page</td>
	  ...
	  <tr class="row">
	  <td width="200">Heroes per page</td>
	  ...
	  <tr class="row">
	  <td width="200">Fastest/Longest Game Time Won</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Show frequently used hero items</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Show most used heroes for every items </td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Smart Parsing Replays</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Show total wons</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Show filters on game page</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Show Country Flags</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Top Players per page</td>
	  ...
	  <tr class="row">
	  <td width="200">All Time Stats on Top page</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Players on top stats</td>
	  ...
	  <tr class="row">
	  <td width="200">Hide Banned Users</td>
	  <td>
	  ...
	  <tr class="row"><th>Misc</th><th></th></tr>
	  
	  <tr class="row">
	  <td width="200">Items page</td>
	  <td>
	  <input type="radio" name="items" '.$itpy.' value="1" /> Yes
	  <input type="radio" name="items" '.$itpn.' value="0" /> No 
	  | (Enable <b>Items</b> page.)</td></tr>
	  
	  <tr class="row">
	  <td width="200">Safelist page</td>
	  <td>
	  <input type="radio" name="sfp" '.$sfpy.' value="1" /> Yes
	  <input type="radio" name="sfp" '.$sfpn.' value="0" /> No 
	  | (Enable <b>Safelist</b> page. <strong>GhostOne</strong> Feature)</td></tr>
	  
	  	  
	  <tr class="row">
	  <td width="200">Enable Warns and Expire date</td>
	  <td>
	  <input type="radio" name="wy" '.$warny.' value="1" /> Yes
	  <input type="radio" name="wy" '.$warnn.' value="0" /> No 
	  | (Enable warns - <strong>GhostOne</strong> Feature)</td></tr>
	  ...
	  <tr class="row">
	  <td width="200">Search limit</td>
	  <td><input value="'.$search_limit.'" type="text" name="search" size=5 /> The max. number of results returned on a search page</td></tr>
	  
	  <tr class="row">
	  <td width="200">Pagination links</td>
	  <td><input value="'.$max_pagination_link.'" type="text" name="pagination" size=5 /> Page links after and before current page</td></tr>
	  
	  <!--<tr class="row">
	  <td width="200">Score formula</td>
	  <td><textarea id="formula" name="formula" style="width:500px;height:64px;" >'.$scoreFormula.'</textarea></td></tr>-->
	  
	  <tr class="row">
	  <td valign="top" width="200">Min Played Ratio</td>
	  <td><input value="'.$minPlayedRatio.'" type="text" name="minratio" size=5 /> Minimal ratio (lefttime/duration) that a player/hero has to complete a game to be counted as win/loss</td></tr>
	  
	  <tr class="row">
	  <td width="200">Min Games Played</td>
	  ...
	  <tr class="row">
	  <td width="200">Parse hero from playdota.com</td>
	  <td>
	  <input type="radio" name="pdh" '.$pdhy.' value="1" /> Yes
	  <input type="radio" name="pdh" '.$pdhn.' value="0" /> No 
	  | (Experimental) Get heroes data from playdota.com instead from database</td></tr>
	  ...
	  <tr class="row">
	  <td width="200">Display user disconnects</td>
	  <td>
	  ...
	  | (Display user disconnects on user page)</td></tr>
	  	  ...
	  	  <tr class="row">
	  <td width="200">Enable user achievements</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Replay Location</td>
	  <td><input value="'.$replayLocation.'" type="text" name="replay" size=30 /> ( http://mysite.com/<b>'.$replayLocation.'</b> )</td></tr>
	  
	  <tr class="row">
	  <td  valign="top" width="200">Replay TimeShift</td>
	  <td><input value="'.$replayTimeOffset.'" type="text" name="replayoffset" maxlength=3 size=3 /> You can use timeoffset to match replay date (from -12 to 13 hours)<br>If replays working fine dont change this value (default <b>0</b>)</td></tr>
	  
	  	  <tr class="row"><th>Monthly</th><th></th></tr>
	  
	  <tr class="row">
	  <td width="200">Monthly Stats</td>
	  <td><input value="'.$monthly_stats.'" type="text" name="monthly" maxlength=5 size=5 /> Number of entries in each highscore list</td></tr>
	  
	  <tr class="row">
	  <td width="200">Monthly row 1</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Display days on monthly stats</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Display top ranks</td>
	  <td>
	  ...
	  <tr class="row"><th>Points and Score</th><th></th></tr>
	  
	  <tr class="row">
	  <td width="200">Score Method</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Accurate points calculation</td>
	  <td>
	  ...
	  <tr class="row">
	  <td width="200">Show All Slots in Game</td>
	  <td>
	  ...
	  <tr class="row"><th>Signature</th><th></th></tr>
	  <tr class="row">
	  <td>Enable Signature creator</td><td>
	  <input type="radio" name="signature" '.$signy.' value="1" /> Yes
	  <input type="radio" name="signature" '.$signn.' value="0" /> No 
	  | (If enabled users can create their signatures)</td></tr>
	  
	  <tr class="row">
	  <td width="200">Min.games for signature</td>
	  <td><input value="'.$sigMinGames.'" type="text" name="sigmn" maxlength=5 size=10 /> (Minimum number of games played to create signature)</td></tr>
	  
	  <tr class="row">
	  <td width="200">Signature cache</td>
	  <td><input value="'.$sigCacheTime.'" type="text" name="sigct" maxlength=5 size=10 /> (Cache time of signature - in minutes)</td></tr>
	  
	  <tr class="row">
	  <td width="200">Signature image quality</td>
	  <td><input value="'.$sigImageQuality.'" type="text" name="sigiq" maxlength=5 size=10 /> (Signature image quality from 0 to 100)</td></tr>
	 
	  <tr class="row">
	  <td>Country flags on signature</td><td>
	  <input type="radio" name="sigflags" '.$cfsy.' value="1" /> Yes
	  <input type="radio" name="sigflags" '.$cfsn.' value="0" /> No 
	  | <br />(Show country flags on signature)<br /><b>Country Flags Addon:</b> '.$cfinst.'</td></tr>
	  	  
	  <tr class="row"><th>Cache</th><th></th></tr>
	  <tr class="row">
	  ...
	  <tr class="row">
	  <td width="200">Cache directory</td>
	  ...
	  write_value_of('$WarnAndExpireDate', "$WarnAndExpireDate", $_POST['wy']);
	  ...
	  write_value_of('$enableItemsPage', "$enableItemsPage", $_POST['items']);
	  write_value_of('$enableSafeListPage', "$enableSafeListPage", $_POST['sfp']);
	  ...
	  write_value_of('$ParsePDHeroes', "$ParsePDHeroes", $_POST['pdh']);
	  ...
	  write_value_of('$enableSignatures', "$enableSignatures", $_POST['signature']);
	  write_value_of('$sigMinGames', "$sigMinGames", $_POST['sigmn']);
	  write_value_of('$sigCacheTime', "$sigCacheTime", $_POST['sigct']);
	  write_value_of('$sigImageQuality', "$sigImageQuality", $_POST['sigiq']);
	  write_value_of('$sigCountryFlags', "$sigCountryFlags", $_POST['sigflags']);
	  ...
	  <a href='index.php?conf'>Back to previous page</a><br><br>";
	   ...
	   //// BACKUP ///
	   ///////////////////////////////////////////////////////////////////////////////
	   if (isset($_GET['tools']) AND !isset($_GET['doit']) AND $_SESSION['user_level'] <=1){
    ...
    ?> 
	   <div align='center'><table style='width:400px;margin-top:20px;'><tr><th>Tools</th><th></th></tr>
	   <tr class='row'>
	   <td width='200'>Optimize tables</td>
	   <td><a title='Click here to optimize tables' class='menuButtons' href='index.php?optimize'>Optimize tables</a></td></tr>
	   <tr class='row'>
	   <td width='200'>Show tables</td>
	   <td><a title='Click here to show tables' class='menuButtons' href='index.php?show_tables'>Show tables</a></td></tr>
	   <tr class='row'>
	   <td width='200'>Purge cache</td>
	   <td><a title='Click here to delete all cache files' class='menuButtons' href='index.php?delete_cache'>Empty cache (<?=$file_count?>)</a></td></tr></table></div><br />
	   
	   <div align='center'>
	   <table style='width:400px;margin-top:20px;'><tr>
	   <th>Backup</th><th></th></tr>
	   <tr class='row'>
	   <td width='200'>Backup database (<?=$database_size?>)</td><td><a title='Click here to begin backup. Please be patient as this process can take a while.' class='menuButtons' href='index.php?tools&backup&doit'>Backup</a></td>
	   </tr></table></div><br />
	   <?php
	   if ($database_size >=30) {echo "<strong>Note:</strong> It is NOT recommended to backup a large database. <br />Better use PhpMyAdmin.";}
      ...
      for($index=0; $index < $indexCount; $index++) {
		...
		echo("<TR class='row'><TD height='32'><a href=\"backup/$dirArray[$index]\">$dirArray[$index]</a> | <a href=\"?delete_backup=$dirArray[$index]\"><b>Delete</b></a></td>");
      ...
      echo("</TABLE></div><br>");
	   ...
	   if (isset($_GET['delete_cache']) AND $_SESSION['user_level'] <=3)
	   {
	$exts = array('html');
    $limit_delete = 1000; // How many files per page
    ...
    closedir($dir);
    //...FOR PAGINATION - NOT IN USE!!!
    $file_count = count($files);
    $page_count = ceil( $file_count / $limit_delete );
    ...
    $offset = ( ( $page - 1 ) * $limit_delete );

	$total_on_page = $limit_delete-(($page*$limit_delete) - $file_count);

    if ($total_on_page<$limit_delete) {$limit_delete = $total_on_page;}

	$count_deleted_files = 0;
    for( $i = $offset; $i < ( $offset + $limit_delete ); $i++ )
    {	
        //$files[$i]['path'];
        //$files[$i]['filename'];
       if (file_exists("../".$cacheDir."/".$files[$i]['filename']))
		{
		$current_file = $files[$i]['filename'];
		$file_to_delete = "../".$cacheDir."/".$files[$i]['filename'];
		if (file_exists($file_to_delete))
		   {unlink($file_to_delete); $count_deleted_files ++;}
		} 
    }?>
	<div align='center'><table style="width:500px;margin-top:8px;">
	<tr class="row"><td align="right">Total Files: </td><td width="50%" align="left"> <?=$file_count?></td></tr>
	<tr class='row'><td align="right">Deleted Files: </td><td align="left"> <?=$count_deleted_files?></td>
	
	</tr></table></div>
	<br /><a href="index.php?tools">Back to previous page</a><br /> <br />
	<?php
	}
	   ...
	   if (isset($_GET['delete_backup']) AND !isset($_GET['tools']) 
       ...
       $res = unlink("./backup/".$_GET['delete_backup']);}
			  ...
			  <a href='index.php?tools'>Back to previous page</a><br><br>";} 
			  else {$res=""; echo "File not exists";}
       }
	   
	   if (isset($_GET['show_tables']) AND !isset($_GET['tools']) 
	   AND !isset($_GET['doit']) AND $_SESSION['user_level'] <=1){
	   ...
	   $table_safelist = $db->table_size("safelist",$database);
	   //$database_size = $db->database_size($database);
	   echo "<br><a href='index.php?tools'>Back to previous page</a><br><br><div align='center'><table border=1 style='width:430px;'>
	   <tr><th>Table: $database</th><th style='padding:6px;'>Size:<p class='alignright'></p></th></tr>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>admins</b></td><td style='padding:6px;'>$table_admins</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>bans</b></td><td style='padding:6px'>$table_bans</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>dotagames</b></td><td style='padding:6px'>$table_dotagames</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>dotaplayers</b></td><td style='padding:6px'>$table_dotaplayers</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>downloads</b></td><td style='padding:6px'>$table_downloads</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>gameplayers</b></td><td style='padding:6px'>$table_gameplayers</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>games</b></td><td style='padding:6px'>$table_games</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>heroes</b></td><td style='padding:6px'>$table_heroes</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>items</b></td><td style='padding:6px'>$table_items</td>
	   <tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>news</b></td><td style='padding:6px'>$table_news</td>";
	   if ($enableSafeListPage == 1)
	   echo "<tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>safelist</b></td><td style='padding:6px'>$table_safelist</td>";
	   echo "<tr class='row'><td style='padding-right:4px;' width='180' align='right'><b>scores</b></td><td style='padding:6px'>$table_scores</td>
	   </tr></table><br><br><a href='index.php?tools'>Back to previous page</a><br><br>";
	   }
	   
	   if (isset($_GET['optimize']) AND !isset($_GET['tools']) 
	   AND !isset($_GET['doit']) AND $_SESSION['user_level'] <=1)
	   {
	$sql = " 
	 OPTIMIZE TABLE 
	...
	$result = $db->query($sql);
	if ($result)
	{echo "<br /><div align='center'>All tables optimized.<br /><br /><a href = 'index.php?tools'>Back to previous page</a></div><br>";}
 ...
 if (!$_GET){
   ...
   echo "Auto-check version failed. Curl is NOT installed. Please check your PHP configuration.<br>However, you can manually check latest version:<br><br><a target='_blank' class='inputButton' href='https://sourceforge.net/projects/dotaopenstats/'>Download OpenStats</a><br><br>";}
	...
	echo "<div align='center'><div style='width:500px;background-color:#FFFFE0;color:#000;padding:4px;border:2px solid #E6DB55;'>
	 <b>Notice:</b> There are <strong>$file_count</strong> cached files.<br><br>
	  You can clean you cache folder <a href='index.php?tools'><strong>here</strong></a>.</div><br><br></div>";
	}
	//END - NOTICE: cached files
	 if ($_debug == 1)
	 {echo "<div align='center'><div style='width:500px;background-color:#FFFFE0;color:#000;padding:4px;border:2px solid #E6DB55;'>
  ...
  $sql = "SELECT winner, dp.gameid, gp.colour, newcolour, original as hero, description, kills, deaths, assists, creepkills, creepdenies, neutralkills, towerkills, gold,  raxkills, courierkills, duration, datetime, 
	   ...
	   ORDER BY newcolour";
		  ...
		  <img alt='' style='vertical-align:middle;' border=0 width='18' height='18'
		 ...
		 echo "<tr class='row'>
		 <td align='right'  width='42'><span $class>$ncol</span> --></td>
		 <td align='center' width='24'><span $class2>$col</span></td>
		 <td align='left' width='140'>$player</td>
		 <td align='left' width='48'><img width='24' height='24' alt='' src='../img/heroes/$hero.gif' /></td>
		 <td title='Kills/Deaths/Assists' align='left' width='64'>$k/$d/$a</td>
		 <td title='Creep Kills/Denies/Neutrals' align='left' width='64'>$c/$cd/$n</td>
		 <td align='left' width='144'>
		 <img width='24' height='24' alt='' src='../img/items/$i1' />
		 <img width='24' height='24' alt='' src='../img/items/$i2' />
		 <img width='24' height='24' alt='' src='../img/items/$i3' />
		 <img width='24' height='24' alt='' src='../img/items/$i4' />
		 <img width='24' height='24' alt='' src='../img/items/$i5' />
		 <img width='24' height='24' alt='' src='../img/items/$i6' />
		 </td>
        ...
        echo "<tr><td></td>
		<td></td><td></td><td></td><td></td><td></td><td width='220'>Winner: <b>$_win </b>($duration)</td><td><span style='background-color:#FAFCEE;color:#950001;'>$err2</span> <b>$gamename </b></td>
		</tr><table></div>";
		...
		$sql = "SELECT 
		  ...
		  <th><a href='index.php?games&check&order=creator&sort=$sort'>Creator</a></th><th></th></tr>";
		   ...
		   echo "<tr class='row'>
		   <td align='left' class='padLeft' width='64'>
		   <input type='checkbox' name='checkbox[]' value='$row[id]'>
		   <a href='index.php?games&check&id=$row[id]'>$row[id]</a></td>
		   <td align='left' width='250'><a href='index.php?games&check&id=$row[id]$_winner$_page'>$gn</a></td>
		   <td align='left' width='120'>$duration</td>
		   <td align='left' width='170'>$gdate</td>
		   <td align='left'><a href='../user.php?u=$gcreator'>$gcreator</a>
		   <p class='alignright'>
		    <a href='javascript:confirmDeleteGame(\"index.php?delete_game=$row[id]\");'>
			<img border=0 alt='' width='16' height='16' 
	  ...
	  $result = $db->query($sql);
			  ...
			  $AServer = $row["server"];
			  echo "<tr class='row'>
			  <td width='48' align='center' class='padLeft'>$AID</td>
			  <td width='200' align='left'><a href='index.php?edit_admin=$AID'>$Aname</a></td>
			  <td width='180'  align='left'><a href='index.php?edit_admin=$AID'>Edit</a>
			  ...
			  <td WIDTH = '65' align='left'>$ABotID</td>
	  ...
	  <tr class="row">
	  <td width="70" align="right">BotID:</td>
	  <td><input id="name" type="text" name="bot" value="'.$ABotID.'" size="8" maxlength="8"/></td></tr>
	  <td width="70" align="right">Server:</td>
	  <td><input id="name" type="text" name="server" value="'.$AServer.'" size="25" maxlength="30"/></td></tr>
	  <td></td>
	  <td><input type="submit" class="inputButton" value="'.$butt.' '.$Aname.'" /> <input type="button" class="inputButton" onclick="location=\'index.php?admins\'" value="Cancel" /></td></tr>
	</form></table></div><br>';
	  }
	 ...
	 &copy; <?php echo date("Y")?> <a href='http://openstats.iz.rs'><b>DotA OpenStats</b></a>
	       </td>
	   </tr>
	  </table>
	 </div>

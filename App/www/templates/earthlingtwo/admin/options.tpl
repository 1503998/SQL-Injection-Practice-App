...
<form action="options.php?pt=options&pag=options" method="POST">
	...
	<p align="center"> {$LAN_33}<br />
		...
		<br />
		{$LAN_121}<br />
		<input name="mochi" type="text" value="{$options[options].mochi_id}" size="30" maxlength="200" />
		<br />
		<br />
		{$LAN_122}<br />
		<input name="url" type="text" value="{$options[options].site_url}" size="30" maxlength="200" />
		<br />
	</p>
	<p align="center">{$LAN_69}<br />
		<input name="template" type="text" value="{$options[options].template}" size="30" maxlength="200" />
	</p>
	<p align="center"><br />
		{$LAN_58}<br />

...
<ul id="admin-menu">
<li><a href="../index.php">{$LAN_41}</a></li><li {if $pag eq "vid"}class='selected'{/if}> <a href="admin_manage.php?pag=vid">{$LAN_68}</a> </li><li {if $pag eq "options"}class='selected'{/if}><a href="options.php?pt=options&amp;pag=options">{$LAN_48}</a> </li><li><a href="logout.php">{$LAN_42}</a></li>
</ul>
...
<li {if $pagetype eq "edit"}class='selected'{/if}><a href="videos_manage.php?pt=edit">{$LAN_79}</a></li>
<li><a href="addgame.php">{$LAN_126}</a></li>
{/if}
{if $pag eq "options"}
...
<li {if $pagetype eq "comment"}class='selected'{/if}><a href="comment.php?pt=comment&amp;pag=options">{$LAN_78}</a></li>
{/if}
</ul>

<?PHP
  ...
  if ($WarnAndExpireDate == 1) $sqlWarn = " bans.warn, "; else $sqlWarn = "";
  
  $sql = "
  SELECT 
  gp.name AS name, bans.name AS banname, bans.reason AS banreason, $sqlWarn count(1) AS counttimes, gp.ip AS ip
  FROM 
  gameplayers gp 
  ...
  if ($WarnAndExpireDate == 1) {
	 ...
	 if ($list["warn"] == 1)  {$BANNED =  "$lang[warn] $list[banreason]"; $COLOR = "style='color:#DC0000;'";}
	 }
  ...
  //Find hero with most kills
   ...
   LIMIT 1";
	...
	$mkhimg = "<a href='hero.php?hero=$mostkillshero'><img width='64' title='$mostkillsheroname' alt='' src='img/heroes/$mostkillshero.gif'/ border=0></a>";
	$mdhimg = "<a href='hero.php?hero=$mostdeathshero'><img width='64' title='$mostdeathsheroname' alt='' src='img/heroes/$mostdeathshero.gif' border=0 /></a>";
	$mahimg = "<a href='hero.php?hero=$mostassistshero'><img width='64' title='$mostassistsheroname' alt='' src='img/heroes/$mostassistshero.gif' border=0/></a>";
	$mwhimg = "<a href='hero.php?hero=$mostwinshero'><img width='64' title='$mostwinsheroname' alt='' src='img/heroes/$mostwinshero.gif' border=0/></a>";
	$mlhimg = "<a href='hero.php?hero=$mostlosseshero'><img width='64' title='$mostlossesheroname' alt='' src='img/heroes/$mostlosseshero.gif' border=0/></a>";
	$mphimg = "<a href='hero.php?hero=$mostplayedhero'><img width='64' title='$mostplayedheroname' alt='' src='img/heroes/$mostplayedhero.gif' border=0/></a>";

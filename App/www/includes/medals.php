<?PHP
		...
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/kills.png'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/assist.png'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/winperc.gif'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/killperc.gif'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/games.png'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/wins.png'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/creeps.gif'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/denies.gif'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/towers.png'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/couriers.gif'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/neutrals.png'></td>
		...
		$buildAchievements .= "<tr class='row'>
		<td width='72' align='left'><img $opacity alt='' width='48' border=0 src='./img/achievements/play.gif'></td>

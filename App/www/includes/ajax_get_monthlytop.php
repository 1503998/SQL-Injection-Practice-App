...
$sql = "
  ...
  <th><div align='center'>$lang[neutrals]</div></th>
	 ...
	 echo "<tr class='row'>
		<td width='180' style='padding-left:4px;'>$myFlag <a href='user.php?u=$plName'>$list[name]</a></td>
		<td width='110'><div align='center'>$list[totalscore]</div></td>
		<td width='64'><div align='center'>$totgames</div></td>
		<td width='64'><div align='center'>$wins</div></td>
		<td width='64'><div align='center'>$winlosses%</div></td>
		<td width='70'><div align='center'>$losses</div></td>
		...
		<td width='90'><div align='center'>$killdeathratio:1</div></td>
